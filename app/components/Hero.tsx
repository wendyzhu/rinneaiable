export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white pt-[78px] sm:pt-[88px] pb-6 sm:pb-8 md:pb-10" aria-label="Hero section">
